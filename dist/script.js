    ...
    if (talapatrakEditorViewElement) {
        ...
        talapatrakEditorViewElement.style.display =
            "none";
              ...
              // Hide Shikshanupakaran
         const shikshanupakaranViewElement =
            document.getElementById("shikshanupakaranView");
        
        const shikshanupakaranEditorViewElement =
            document.getElementById("shikshanupakaranEditorView");
        
        
        if (shikshanupakaranViewElement) {
        
            shikshanupakaranViewElement.style.display = "none";
        ...
        if (shikshanupakaranEditorViewElement) {
            ...
            shikshanupakaranEditorViewElement.style.display = "none";
